...
// Ext add
import org.eclipse.settings.aboutphone.EclipseHeaderController;
import org.eclipse.settings.aboutphone.EclipseDeviceInfoCardController;
import org.eclipse.settings.aboutphone.EclipseMaintainerCardController;
...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
        ...
        // Ext add
        controllers.add(new EclipseHeaderController(context, "eclipse_header"));
        controllers.add(new EclipseDeviceInfoCardController(context, "eclipse_device_info_card"));
        controllers.add(new EclipseMaintainerCardController(context, "eclipse_maintainer_card"));
